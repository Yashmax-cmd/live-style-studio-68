...
--
-- Name: product_size; Type: TYPE; Schema: public; Owner: -
--
...
CREATE TABLE public.products (
    ...
    sizes public.product_size[] DEFAULT ARRAY['S'::public.product_size, 'M'::public.product_size, 'L'::public.product_size] NOT NULL,
    in_stock boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT products_price_check CHECK (((price >= 500) AND (price <= 50000)))
);
